...
-->
  ...
  <xsl:if test="$flowdirection = 'RTL'">
	...
	<xsl:if test="$fgdc[text()]">
		<h2 class="fgdc head"><a href="#fgdcMetadata" onclick="hideShow('fgdcMetadata')"><res:idTopFGDC />&#160;<span id="fgdcMetadataShow" class="show">&#9660;</span><span id="fgdcMetadataHide" class="hide">&#9658;</span></a></h2>
