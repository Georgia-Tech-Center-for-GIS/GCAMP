	...
	<div>
		...
		<xsl:for-each select="/metadata/idinfo">
			<xsl:call-template name="tocSectionFGDC">
				...
				<xsl:with-param name="sectionHeading"><xsl:value-of select="res:str('idIdent')"/></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
		...
		<xsl:for-each select="/metadata/dataqual">
			<xsl:call-template name="tocSectionFGDC">
				...
				<xsl:with-param name="sectionHeading"><xsl:value-of select="res:str('idDataQual')"/></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
		...
		<xsl:for-each select="/metadata/spdoinfo">
			<xsl:call-template name="tocSectionFGDC">
				...
				<xsl:with-param name="sectionHeading"><xsl:value-of select="res:str('idSpaDataOrg')"/></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
		...
		<xsl:for-each select="/metadata/spref">
			<xsl:call-template name="tocSectionFGDC">
				...
				<xsl:with-param name="sectionHeading"><xsl:value-of select="res:str('idSpaRef')"/></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>

		<xsl:if test="/metadata/eainfo">
			<xsl:variable name="eleID">eainfo</xsl:variable>
			...
			<h2 class="fgdc">
				<a onclick="hideShow('{$eleID}')" href="#{$eleID}"><xsl:value-of select="res:str('idEntsAndAttribs')"/>&#160;
		...
		<xsl:for-each select="/metadata/distinfo">
			<xsl:call-template name="tocSectionFGDC">
				...
				<xsl:with-param name="sectionHeading"><xsl:value-of select="res:str('idDistInfo_FGDC')"/></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
		...
		<xsl:for-each select="/metadata/metainfo">
			<xsl:call-template name="tocSectionFGDC">
				...
				<xsl:with-param name="sectionHeading"><xsl:value-of select="res:str('idMetaRef')"/></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
      ...
      <xsl:for-each select="status">
        ...
        <dl>
          <xsl:for-each select="progress">
            <dt><span class="element"><res:idProgress/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          <xsl:for-each select="update">
            <dt><span class="element"><res:idMaintAndUpdateFreq/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
        </dl>
        </dd><br />
      </xsl:for-each>
      ...
      <xsl:for-each select="spdom">
        ...
        <dl>
          <xsl:for-each select="bounding">
            ...
            <dd>
            <dl>
              <dt><span class="element"><res:idWestBoundCoord/></span>&#x2003;<xsl:value-of select="westbc"/></dt>
              <dt><span class="element"><res:idEastBoundCoord/></span>&#x2003;<xsl:value-of select="eastbc"/></dt>
              <dt><span class="element"><res:idNorthBoundCoord/></span>&#x2003;<xsl:value-of select="northbc"/></dt>
              <dt><span class="element"><res:idSouthBoundCoord/></span>&#x2003;<xsl:value-of select="southbc"/></dt>
            </dl>
            </dd>
          </xsl:for-each>
          ...
          <xsl:for-each select="theme">
            ...
            <dl>
              <xsl:for-each select="themekt">
                <dt><span class="element"><res:idThemeKeywdThes/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="themekey">
                <dt><span class="element"><res:idThemeKeywd/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd><br />
          </xsl:for-each>
          ...
          <xsl:for-each select="place">
            ...
            <dl>
              <xsl:for-each select="placekt">
                <dt><span class="element"><res:idPlaceKeywdThes/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="placekey">
                <dt><span class="element"><res:idPlaceKeywd/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd><br />
          </xsl:for-each>
          ...
          <xsl:for-each select="stratum">
            ...
            <dl>
              <xsl:for-each select="stratkt">
                <dt><span class="element"><res:idStratumKeywdThes/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="stratkey">
                <dt><span class="element"><res:idStratumKeywd/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd><br />
          </xsl:for-each>
          ...
          <xsl:for-each select="temporal">
            ...
            <dl>
              <xsl:for-each select="tempkt">
                <dt><span class="element"><res:idTemporalKeywdThes/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="tempkey">
                <dt><span class="element"><res:idTemporalKeywd/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd><br />
          </xsl:for-each>
      ...
      <xsl:for-each select="browse">
        ...
        <dl>
          ...
          <xsl:for-each select="browset">
            <dt><span class="element"><res:idBrowseGraphicFType/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
        </dl>
        </dd><br />
      </xsl:for-each>
      ...
      <xsl:for-each select="secinfo">
        ...
        <dl>
          <xsl:for-each select="secsys">
            <dt><span class="element"><res:idSecClassSys/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          <xsl:for-each select="secclass">
            <dt><span class="element"><res:idSecClass/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          <xsl:for-each select="sechandl">
            <dt><span class="element"><res:idSecHandlingDesc/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
        </dl>
        </dd><br />
      </xsl:for-each>
  ...
  <dl>
    ...
    <dl>
          ...
          <xsl:for-each select="qattracc">
            ...
            <dl>
              <xsl:for-each select="attraccv">
                <dt><span class="element"><res:idAttribAccVal/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              ...
              <xsl:for-each select="qhorizpa">
                ...
                <dl>
                  <xsl:for-each select="horizpav">
                    <dt><span class="element"><res:idHorizPosAccVal/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
              ...
              <xsl:for-each select="qvertpa">
                ...
                <dl>
                  <xsl:for-each select="vertaccv">
                    <dt><span class="element"><res:idVertPosAccVal/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
          ...
          <xsl:for-each select="srcinfo">
            ...
            <dl>
              ...
              <xsl:for-each select="srcscale">
                <dt><span class="element"><res:idSrcScaleDenom/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="typesrc">
                <dt><span class="element"><res:idTypeSrcMedia/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
          ...
          <xsl:for-each select="procstep">
            ...
            <dl>
              ...
              <xsl:for-each select="procdate">
                <dt><span class="element"><res:idProcDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
              </xsl:for-each>
              <xsl:for-each select="proctime">
                <dt><span class="element"><res:idProcTime/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
      ...
      <xsl:for-each select="cloud">
        <dt><span class="element"><res:idCloudCover/></span>&#x2003;<xsl:value-of select = "." /></dt>
      </xsl:for-each>
    </dl>
    </dd>
  </dl>
...
<xsl:template match="spdoinfo" mode="fgdc">
  <dl>
    <dd>
    <dl>
      <xsl:for-each select="indspref">
        <dt><span class="element"><res:idIndirectSpaRefMethod/></span></dt>
        <dd><xsl:value-of select = "." /></dd><br /><br />
      </xsl:for-each>

      <xsl:for-each select="direct">
        <dt><span class="element"><res:idDirectSpaRefMethod/></span>&#x2003;<xsl:value-of select = "." /></dt><br /><br />
      </xsl:for-each>
          ...
          <xsl:for-each select="sdtsterm">
            ...
            <dl>
              <xsl:for-each select="sdtstype">
                <dt><span class="element"><res:idSdtsPtVecObjType/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="ptvctcnt">
                <dt><span class="element"><res:idPtVecObjCnt/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd><br />
          </xsl:for-each>
          ...
          <xsl:for-each select="vpfterm">
            ...
            <dl>
              <xsl:for-each select="vpflevel">
                <dt><span class="element"><res:idVpfTopoLvl/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="vpfinfo">
                ...
                <dl>
                  <xsl:for-each select="vpftype">
                    <dt><span class="element"><res:idVpfPtVecObjType/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                  <xsl:for-each select="ptvctcnt">
                    <dt><span class="element"><res:idPtVecObjCnt_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                </dl>
                </dd>
              </xsl:for-each>
      ...
      <xsl:for-each select="rastinfo">
        ...
        <dl>
          <xsl:for-each select="rasttype">
            <dt><span class="element"><res:idRasterObjType/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          <xsl:for-each select="rowcount">
            <dt><span class="element"><res:idRowCnt/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          <xsl:for-each select="colcount">
            <dt><span class="element"><res:idColCnt/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          <xsl:for-each select="vrtcount">
            <dt><span class="element"><res:idVertCnt/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
        </dl>
        </dd>
      </xsl:for-each>
          ...
          <xsl:for-each select="geograph">
            ...
            <dl>
              <xsl:for-each select="latres">
                <dt><span class="element"><res:idLatRez/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="longres">
                <dt><span class="element"><res:idLongRez/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="geogunit">
                <dt><span class="element"><res:idGeoCoordUnits/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd><br />
          </xsl:for-each>
              ...
              <xsl:for-each select="mapproj">
                ...
                <dl>
                  <xsl:for-each select="mapprojn">
                    <dt><span class="element"><res:idMapProjName/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
              ...
              <xsl:for-each select="gridsys">
                ...
                <dl>
                  <xsl:for-each select="gridsysn">
                    <dt><span class="element"><res:idGridCoordSysName/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                  ...
                  <xsl:for-each select="utm">
                    ...
                    <dl>
                      <xsl:for-each select="utmzone">
                        <dt><span class="element"><res:idUtmZoneNum/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="transmer">
                  ...
                  <xsl:for-each select="ups">
                    ...
                    <dl>
                      <xsl:for-each select="upszone">
                        <dt><span class="element"><res:idUpsZoneID/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="polarst">
                  ...
                  <xsl:for-each select="spcs">
                    ...
                    <dl>
                      <xsl:for-each select="spcszone">
                        <dt><span class="element"><res:idSpcsZoneID/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="lambertc">
                  ...
                  <xsl:for-each select="arcsys">
                    ...
                    <dl>
                      <xsl:for-each select="arczone">
                        <dt><span class="element"><res:idArcSysZoneID/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="equirect">
              ...
              <xsl:for-each select="planci">
                ...
                <dl>
                  <xsl:for-each select="plance">
                    <dt><span class="element"><res:idPlanarCoordEncodMethod/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                  <xsl:for-each select="coordrep">
                    ...
                    <dl>
                      <xsl:for-each select="absres">
                        <dt><span class="element"><res:idAbscissaReso/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="ordres">
                        <dt><span class="element"><res:idOrdinateReso/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                    </dl>
                    </dd>
                  </xsl:for-each>
                  <xsl:for-each select="distbrep">
                    ...
                    <dl>
                      <xsl:for-each select="distres">
                        <dt><span class="element"><res:idDistReso/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="bearres">
                        <dt><span class="element"><res:idBearingReso/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="bearunit">
                        <dt><span class="element"><res:idBearingUnits/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="bearrefd">
                        <dt><span class="element"><res:idBearingRefDir/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="bearrefm">
                        <dt><span class="element"><res:idBearingRefMeridian/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                    </dl>
                    </dd>
                  </xsl:for-each>
                  <xsl:for-each select="plandu">
                    <dt><span class="element"><res:idPlanarDistUnits/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                </dl>
                </dd><br />
              </xsl:for-each>
          ...
          <xsl:for-each select="local">
            ...
            <dl>
              <xsl:for-each select="localdes">
                <dt><span class="element"><res:idLocalDesc/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
          ...
          <xsl:for-each select="geodetic">
            ...
            <dl>
              <xsl:for-each select="horizdn">
                <dt><span class="element"><res:idHorizDatumName/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="ellips">
                <dt><span class="element"><res:idEllipsName/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="semiaxis">
                <dt><span class="element"><res:idSemimajorAxis/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="denflat">
                <dt><span class="element"><res:idDenomFlatRatio/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd>
          </xsl:for-each>
          ...
          <xsl:for-each select="altsys">
            ...
            <dl>
              <xsl:for-each select="altdatum">
                <dt><span class="element"><res:idAltDatumName/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="altres">
                <dt><span class="element"><res:idAltReso/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="altunits">
                <dt><span class="element"><res:idAltDistUnits/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="altenc">
                <dt><span class="element"><res:idAltEncMethod/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd>
          </xsl:for-each>
          ...
          <xsl:for-each select="depthsys">
            ...
            <dl>
              <xsl:for-each select="depthdn">
                <dt><span class="element"><res:idDepthDatumName/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="depthres">
                <dt><span class="element"><res:idDepthReso/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="depthdu">
                <dt><span class="element"><res:idDepthDistUnits/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              <xsl:for-each select="depthem">
                <dt><span class="element"><res:idDepthEncMethod/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd>
          </xsl:for-each>
          ...
          <xsl:for-each select="enttyp">
            ...
            <dl>
              <xsl:for-each select="enttypl">
                <dt><span class="element"><res:idEntityTypeLbl/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              ...
              <xsl:for-each select="enttypds">
                <dt><span class="element"><res:idEntityTypeDefSrc/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
            </dl>
            </dd><br />
          </xsl:for-each>
          ...
          <xsl:for-each select="attr">
            ...
            <dl>
              <xsl:for-each select="attrlabl">
                <dt><span class="element"><res:idAttribLbl/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
              ...
              <xsl:for-each select="attrdefs">
                  <dt><span class="element"><res:idAttribDefSrc/></span>&#x2003;<xsl:value-of select = "." /></dt>
              </xsl:for-each>
                  ...
                  <xsl:for-each select="edom">
                    ...
                    <dl>
                      <xsl:for-each select="edomv">
                        <dt><span class="element"><res:idEnumDomainVal/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      ...
                      <xsl:for-each select="attr">
                        <dt><span class="element"><res:idAttrib_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                    </dl>
                    </dd>
                  </xsl:for-each>
                  ...
                  <xsl:for-each select="rdom">
                    ...
                    <dl>
                      <xsl:for-each select="rdommin">
                        <dt><span class="element"><res:idRangeDomainMin/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="rdommax">
                        <dt><span class="element"><res:idRangeDomainMax/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="attrunit">
                        <dt><span class="element"><res:idAttribUnitsMeasure/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="attrmres">
                        <dt><span class="element"><res:idAttribMeasureReso/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="attr">
                        <dt><span class="element"><res:idAttrib_FGDC2/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                    </dl>
                    </dd>
                  </xsl:for-each>
                  ...
                  <xsl:for-each select="codesetd">
                    ...
                    <dl>
                      <xsl:for-each select="codesetn">
                        <dt><span class="element"><res:idCodesetName/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="codesets">
                        <dt><span class="element"><res:idCodesetSrc/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                    </dl>
                    </dd>
                  </xsl:for-each>
              ...
              <xsl:for-each select="begdatea">
                <dt><span class="element"><res:idBeginDateAttribVals/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
              </xsl:for-each>
              <xsl:for-each select="enddatea">
                <dt><span class="element"><res:idEndDateAttribVals/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
              </xsl:for-each>
              ...
              <xsl:for-each select="attrvai">
                ...
                <dl>
                  <xsl:for-each select="attrva">
                    <dt><span class="element"><res:idAttribValAcc/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
  ...
  <dl>
    ...
    <dl>
      ...
      <xsl:for-each select="resdesc">
        <dt><span class="element"><res:idResourceDesc/></span>&#x2003;<xsl:value-of select = "." /></dt>
      </xsl:for-each>
      ...
      <xsl:for-each select="stdorder">
        ...
        <dl>
              ...
              <xsl:for-each select="digtinfo">
                ...
                <dl>
                  <xsl:for-each select="formname">
                    <dt><span class="element"><res:idFormatName_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                  <xsl:for-each select="formvern">
                    <dt><span class="element"><res:idFormatVersNum/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                  <xsl:for-each select="formverd">
                    <dt><span class="element"><res:idFormatVersDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
                  </xsl:for-each>
                  ...
                  <xsl:for-each select="filedec">
                    <dt><span class="element"><res:idFileDecompressTech/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                  <xsl:for-each select="transize">
                    <dt><span class="element"><res:idXferSize/></span>&#x2003;<xsl:value-of select = "." /></dt>
                  </xsl:for-each>
                </dl>
                </dd><br />
              </xsl:for-each>
                          ...
                          <xsl:for-each select="dialinst">
                            ...
                            <dl>
                              <xsl:for-each select="lowbps">
                                <dt><span class="element"><res:idLowestBPS/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                              <xsl:for-each select="highbps">
                                <dt><span class="element"><res:idHighestBPS/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                              <xsl:for-each select="numdata">
                                <dt><span class="element"><res:idNumDataBits/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                              <xsl:for-each select="numstop">
                                <dt><span class="element"><res:idNumStopBits/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                              <xsl:for-each select="parity">
                                <dt><span class="element"><res:idParity/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                              <xsl:for-each select="compress">
                                <dt><span class="element"><res:idCompressionSupport/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                              <xsl:for-each select="dialtel">
                                <dt><span class="element"><res:idDialupTelephone/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                              <xsl:for-each select="dialfile">
                                <dt><span class="element"><res:idDialupFileName/></span>&#x2003;<xsl:value-of select = "." /></dt>
                              </xsl:for-each>
                            </dl>
                            </dd>
                          </xsl:for-each>
                  ...
                  <xsl:for-each select="offoptn">
                    ...
                    <dl>
                      <xsl:for-each select="offmedia">
                        <dt><span class="element"><res:idOfflineMedia/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
                      <xsl:for-each select="reccap">
                        ...
                        <dl>
                          <xsl:for-each select="recden">
                            <dt><span class="element"><res:idRecordDensity/></span>&#x2003;<xsl:value-of select = "." /></dt>
                          </xsl:for-each>
                          <xsl:for-each select="recdenu">
                            <dt><span class="element"><res:idRecordDensityUnits/></span>&#x2003;<xsl:value-of select = "." /></dt>
                          </xsl:for-each>
                        </dl>
                        </dd>
                      </xsl:for-each>
                      <xsl:for-each select="recfmt">
                        <dt><span class="element"><res:idRecordFormat/></span>&#x2003;<xsl:value-of select = "." /></dt>
                      </xsl:for-each>
          ...
          <xsl:for-each select="fees">
            <dt><span class="element"><res:idFees_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          ...
          <xsl:for-each select="turnarnd">
            <dt><span class="element"><res:idTurnaround_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
        </dl>
        </dd><br />
      </xsl:for-each>
  ...
  <dl>
    ...
    <dl>
      <xsl:for-each select="metd">
        <dt><span class="element"><res:idMetaDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
      </xsl:for-each>
      <xsl:for-each select="metrd">
        <dt><span class="element"><res:idMetaRevDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
      </xsl:for-each>
      <xsl:for-each select="metfrd">
        <dt><span class="element"><res:idMetaFutureRevDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
      </xsl:for-each>
      ...
      <xsl:for-each select="metstdn">
        <dt><span class="element"><res:idMetaStdName/></span>&#x2003;<xsl:value-of select = "." /></dt>
      </xsl:for-each>
      <xsl:for-each select="metstdv">
        <dt><span class="element"><res:idMetaStdVers/></span>&#x2003;<xsl:value-of select = "." /></dt>
      </xsl:for-each>
      <xsl:for-each select="mettc">
        <dt><span class="element"><res:idMetaTimeConvention/></span>&#x2003;<xsl:value-of select = "." /></dt>
      </xsl:for-each>

      <xsl:for-each select="metac">
        <dt><span class="element"><res:idMetaAccConst/></span>&#x2003;<xsl:value-of select = "." /></dt>
      </xsl:for-each>
      ...
      <xsl:for-each select="metsi">
        ...
        <dl>
          <xsl:for-each select="metscs">
            <dt><span class="element"><res:idMetaSecClassSys/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
          <xsl:for-each select="metsc">
            <dt><span class="element"><res:idMetaSecClass/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
      ...
      <xsl:for-each select="metextns">
        ...
        <dl>
          <xsl:for-each select="onlink">
            <dt><span class="element"><res:idOnlineLinkage/></span>&#x2003;<xsl:call-template name="urlType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
          </xsl:for-each>
          <xsl:for-each select="metprof">
            <dt><span class="element"><res:idProfileName/></span>&#x2003;<xsl:value-of select = "." /></dt>
          </xsl:for-each>
        </dl>
        </dd>
      </xsl:for-each>
...
<xsl:template match="citeinfo" mode="fgdc">
  ...
  <dl>
    <xsl:for-each select="origin">
      <dt><span class="element"><res:idOriginator/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>

    <xsl:for-each select="pubdate">
      <dt><span class="element"><res:idPublicationDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
    </xsl:for-each>
    <xsl:for-each select="pubtime">
      <dt><span class="element"><res:idPublicationTime/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    ...
    <xsl:for-each select="edition">
      <dt><span class="element"><res:idEdition_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>

    <xsl:for-each select="geoform">
      <dt><span class="element"><res:idGeoDataPresentationForm/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    ...
    <xsl:for-each select="serinfo">
      ...
      <dl>
        <xsl:for-each select="sername">
          <dt><span class="element"><res:idSeriesName/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="issue">
          <dt><span class="element"><res:idIssueID/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
      </dl>
      </dd>
    </xsl:for-each>
    ...
    <xsl:for-each select="pubinfo">
      ...
      <dl>
        <xsl:for-each select="pubplace">
          <dt><span class="element"><res:idPublicationPlace/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="publish">
          <dt><span class="element"><res:idPublisher/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
      </dl>
      </dd>
    </xsl:for-each>
...
<xsl:template match="cntinfo" mode="fgdc">
  ...
  <dl>
    <xsl:for-each select="cntperp">
      ...
      <dl>
        <xsl:for-each select="cntper">
          <dt><span class="element"><res:idContactPerson/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="cntorg">
          <dt><span class="element"><res:idContactOrg/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
      </dl>
      </dd>
    </xsl:for-each>
    <xsl:for-each select="cntorgp">
      ...
      <dl>
        <xsl:for-each select="cntorg">
          <dt><span class="element"><res:idContactOrg_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="cntper">
          <dt><span class="element"><res:idContactPerson_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
      </dl>
      </dd>
    </xsl:for-each>
    <xsl:for-each select="cntpos">
      <dt><span class="element"><res:idContactPosition/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    ...
    <xsl:for-each select="cntaddr">
      ...
      <dl>
        <xsl:for-each select="addrtype">
          <dt><span class="element"><res:idAddrType/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="address">
            <dt><span class="element"><res:idAddr/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="city">
          <dt><span class="element"><res:idCity_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="state">
          <dt><span class="element"><res:idStateProvince/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="postal">
          <dt><span class="element"><res:idPostalCode_FGDC/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="country">
          <dt><span class="element"><res:idCountry_FGDC/></span>&#x2003;<xsl:apply-templates select="."  mode="arcgis"/></dt>
        </xsl:for-each>
      </dl>
      </dd><br />
    </xsl:for-each>
    ...
    <xsl:for-each select="cntvoice">
      <dt><span class="element"><res:idContactVoiceTelephone/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    <xsl:for-each select="cnttdd">
      <dt><span class="element"><res:idContactTDDTTYTelephone/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    <xsl:for-each select="cntfax">
      <dt><span class="element"><res:idContactFaxTelephone/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    ...
    <xsl:for-each select="hours">
      <dt><span class="element"><res:idHrsSvc/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
...
<xsl:template match="sngdate" mode="fgdc">
  ...
  <dl>
    <xsl:for-each select="caldate">
      <dt><span class="element"><res:idCalendarDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
    </xsl:for-each>
    <xsl:for-each select="time">
      <dt><span class="element"><res:idTimeDay/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
  </dl>
  </dd>
</xsl:template>
...
<xsl:template match="rngdates" mode="fgdc">
  ...
  <dl>
    <xsl:for-each select="begdate">
      <dt><span class="element"><res:idBeginDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
    </xsl:for-each>
    <xsl:for-each select="begtime">
      <dt><span class="element"><res:idBeginTime/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    <xsl:for-each select="enddate">
      <dt><span class="element"><res:idEndDate/></span>&#x2003;<xsl:call-template name="dateType">
				<xsl:with-param name="value" select="." />
			</xsl:call-template></dt>
    </xsl:for-each>
    <xsl:for-each select="endtime">
      <dt><span class="element"><res:idEndTime/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
  </dl>
  </dd>
</xsl:template>
...
<xsl:template match="grngpoin" mode="fgdc">
  ...
  <dl>
    <xsl:for-each select="gringlat">
      <dt><span class="element"><res:idGRingLat/></span>&#x2003;<xsl:value-of select = "." /></dt>
        </xsl:for-each>
        <xsl:for-each select="gringlon">
      <dt><span class="element"><res:idGRingLong/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
  </dl>
  </dd>
</xsl:template>
...
<xsl:template match="stdparll" mode="fgdc">
  <dt><span class="element"><res:idStdParallel/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="longcm" mode="fgdc">
  <dt><span class="element"><res:idLongCentMeridian/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="latprjo" mode="fgdc">
  <dt><span class="element"><res:idLatProjOrigin/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="feast" mode="fgdc">
  <dt><span class="element"><res:idFalseEasting/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="fnorth" mode="fgdc">
  <dt><span class="element"><res:idFalseNorthing/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="sfequat" mode="fgdc">
  <dt><span class="element"><res:idScaleFactEquator/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="heightpt" mode="fgdc">
  <dt><span class="element"><res:idHeightPerspectivePtAboveSurf/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="longpc" mode="fgdc">
  <dt><span class="element"><res:idLongProjCenter/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="latprjc" mode="fgdc">
  <dt><span class="element"><res:idLatProjCenter/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="sfctrlin" mode="fgdc">
  <dt><span class="element"><res:idScaleFactCenterLine/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="obqlazim" mode="fgdc">
  <dt><span class="element"><res:idObliqueLineAzimuth/></span>&#x2003;<xsl:value-of select = "." /></dt>
  <dd>
  <dl>
    <xsl:for-each select="azimangl">
      <dt><span class="element"><res:idAzimuthAngle/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    <xsl:for-each select="azimptl">
      <dt><span class="element"><res:idAzimuthMeasurePtLong/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
  </dl>
  </dd>
</xsl:template>
...
<xsl:template match="obqlpt" mode="fgdc">
  <dt><span class="element"><res:idObliqueLinePt/></span>&#x2003;<xsl:value-of select = "." /></dt>
  <dd>
  <dl>
    <xsl:for-each select="obqllat">
      <dt><span class="element"><res:idObliqueLineLat/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
    <xsl:for-each select="obqllong">
       <dt><span class="element"><res:idObliqueLineLong/></span>&#x2003;<xsl:value-of select = "." /></dt>
    </xsl:for-each>
  </dl>
  </dd>
</xsl:template>
...
<xsl:template match="svlong" mode="fgdc">
  <dt><span class="element"><res:idStraightVertLongPole/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="sfprjorg" mode="fgdc">
  <dt><span class="element"><res:idScaleFactProjOrigin/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="landsat" mode="fgdc">
  <dt><span class="element"><res:idLandsatNum/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="pathnum" mode="fgdc">
  <dt><span class="element"><res:idPathNum/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>

<xsl:template match="sfctrmer" mode="fgdc">
  <dt><span class="element"><res:idScaleFactCentMeridian/></span>&#x2003;<xsl:value-of select = "." /></dt>
</xsl:template>
